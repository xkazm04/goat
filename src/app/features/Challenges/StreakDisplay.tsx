...
function StreakCard({
  ...
  if (compact) {
    return (
      <div className="flex items-center gap-2 px-3 py-2 bg-zinc-900 border border-zinc-800 rounded-card">
...
export function StreakDisplay({
  ...
  if (activeStreaks.length === 0) {
    return (
      <div className="p-6 text-center bg-zinc-900 border border-zinc-800 rounded-card">
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-2">
            {STREAK_MILESTONES.map((milestone) => {
              ...
              return (
                <div
                  key={milestone.days}
                  className={`px-3 py-2 rounded-card border text-center ${
                    unlocked
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="p-4 bg-zinc-900 border border-zinc-800 rounded-card text-center">
