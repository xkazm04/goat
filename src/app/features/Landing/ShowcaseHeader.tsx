...
export function ShowcaseHeader() {
  ...
  const { ref: pauseRef, shouldAnimate } = useAnimationPause({ rootMargin: "200px" });
    ...
    >
      <div className="relative inline-block">
        ...
        >
          ...
          {/* Crown glow - CSS animation */}
          <div
            className="absolute inset-0 -z-10 showcase-glow-pulse"
            style={{
              background: gradients.amberGlow,
              filter: "blur(20px)",
              transform: "scale(3)",
        ...
        {/* Massive background glow - CSS animation */}
        <div
          className="absolute -inset-16 pointer-events-none showcase-bg-glow"
          style={{
            background: gradients.amberBgGlow,
            filter: "blur(20px)",
            animationPlayState: animState,
        ...
        <div className="flex items-center justify-center gap-1 md:gap-2">
          {letters.map((letter, index) => (
            ...
            >
              {letter.char}
              {/* Individual letter glow - CSS animation with staggered delay */}
              {letter.char !== "." && (
                <div
        ...
        >
          <p
            className="text-sm md:text-base font-light tracking-[0.3em] uppercase showcase-subtitle-sweep"
            style={{
          ...
          <div
            ...
            style={{
              background: gradients.amberSubtitleGlow,
              filter: "blur(15px)",
            }}
          />
        </motion.div>
