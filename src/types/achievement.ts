...
export type AchievementCategory = 'curator' | 'social' | 'explorer' | 'champion' | 'milestone';
...
export type AchievementCardStyle = 'default' | 'minimal' | 'vibrant' | 'dark' | 'neon';
...
// Tier configurations for visual styling
export const TIER_CONFIG: Record<AchievementTier, {
  ...
  diamond: {
    ...
    borderColor: 'rgba(185, 242, 255, 0.6)',
  },
};
...
export interface SocialSharePlatform {
  ...
  icon: string;
  color: string;
  generateUrl: (shareUrl: string, text: string) => string;
}

export const ACHIEVEMENT_SHARE_PLATFORMS: SocialSharePlatform[] = [
  {
    id: 'twitter',
    name: 'X',
    icon: 'M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z',
    color: '#1DA1F2',
    generateUrl: (shareUrl, text) =>
      `https://twitter.com/intent/tweet?text=${encodeURIComponent(text)}&url=${encodeURIComponent(shareUrl)}&hashtags=GOAT,Achievement`,
  },
  {
    id: 'facebook',
    name: 'Facebook',
