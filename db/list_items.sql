create table public.list_items (
  ...
  constraint unique_ranking_per_list unique (list_id, ranking) DEFERRABLE INITIALLY DEFERRED,
  constraint list_items_item_id_fkey foreign KEY (item_id) references items (id) on delete RESTRICT,
