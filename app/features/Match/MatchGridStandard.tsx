...
const MatchGridStandard = ({
  ...
  return (
    <div className="grid grid-cols-5 sm:grid-cols-6 md:grid-cols-7 lg:grid-cols-8 xl:grid-cols-9 2xl:grid-cols-10 3xl:grid-cols-10 4xl:grid-cols-12 gap-2 sm:gap-3 lg:gap-4 xl:gap-5 2xl:gap-6">
          ...
          >
            ...
            >
              <div className="flex flex-col items-center gap-2">
                <Plus 
                  className={`w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 xl:w-7 xl:h-7 transition-opacity ${
                    shouldHighlight
                ...
                />
                <span 
                  className={`text-xs sm:text-sm lg:text-base xl:text-lg font-bold ${
                    shouldHighlight
